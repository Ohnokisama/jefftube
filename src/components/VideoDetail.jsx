...
const VideoDetail = () => {
  ...
  return (
    <div className='md:h-[100vh] h-auto overflow-y-auto flex flex-col md:flex-row pt-16 md:pt-24 md:px-12 px-4 gap-10'>
      ...
      <div className='md:basis-1/3 basis-0 h-auto md:h-[100vh] overflow-y-auto no-scrollbar'>
